...
type CeresmetaRpcServiceClient interface {
	...
	AllocTable(ctx context.Context, in *AllocTableRequest, opts ...grpc.CallOption) (*AllocTableResponse, error)
	CommitDDL(ctx context.Context, in *CommitDDLRequest, opts ...grpc.CallOption) (*CommitDDLResponse, error)
...
func (c *ceresmetaRpcServiceClient) AllocTable(ctx context.Context, in *AllocTableRequest, opts ...grpc.CallOption) (*AllocTableResponse, error) {
	out := new(AllocTableResponse)
	err := c.cc.Invoke(ctx, "/meta_service.CeresmetaRpcService/AllocTable", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ceresmetaRpcServiceClient) CommitDDL(ctx context.Context, in *CommitDDLRequest, opts ...grpc.CallOption) (*CommitDDLResponse, error) {
	out := new(CommitDDLResponse)
	err := c.cc.Invoke(ctx, "/meta_service.CeresmetaRpcService/CommitDDL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CeresmetaRpcServiceServer interface {
	...
	AllocTable(context.Context, *AllocTableRequest) (*AllocTableResponse, error)
	CommitDDL(context.Context, *CommitDDLRequest) (*CommitDDLResponse, error)
...
func (UnimplementedCeresmetaRpcServiceServer) AllocTable(context.Context, *AllocTableRequest) (*AllocTableResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AllocTable not implemented")
}
func (UnimplementedCeresmetaRpcServiceServer) CommitDDL(context.Context, *CommitDDLRequest) (*CommitDDLResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CommitDDL not implemented")
}
...
func _CeresmetaRpcService_AllocTable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AllocTableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CeresmetaRpcServiceServer).AllocTable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/meta_service.CeresmetaRpcService/AllocTable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CeresmetaRpcServiceServer).AllocTable(ctx, req.(*AllocTableRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CeresmetaRpcService_CommitDDL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CommitDDLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CeresmetaRpcServiceServer).CommitDDL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/meta_service.CeresmetaRpcService/CommitDDL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CeresmetaRpcServiceServer).CommitDDL(ctx, req.(*CommitDDLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CeresmetaRpcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AllocTable",
			Handler:    _CeresmetaRpcService_AllocTable_Handler,
		},
		{
			MethodName: "CommitDDL",
			Handler:    _CeresmetaRpcService_CommitDDL_Handler,
		},
		{
